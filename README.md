...
I'm currently an NLP Engineer at Seasalt.ai. Seasalt is a startup - I started as an intern when the company was first founded, and am one of the only two full-time NLP engineers.
...
- [SeaVoice Discord Bot](https://wiki.seasalt.ai/seavoice/discord/discord_bot/)
...
After some time of having the bot publish, I did a case study about how users are interacting with the text-to-speech functionality of our bot: [Text-to-Speech on Discord: A TTS Discord Bot Case Study](https://seasalt.ai/blog/29-discord-tts-case-study/). I'm also in the processes of analyzing our speech-to-text data from Discord.
